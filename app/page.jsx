  ...
  return (
    <main className="min-h-screen bg-gray-50 text-gray-800 px-6 py-10 font-sans">
      <header className="text-center mb-10">
        <img
          src="/assets/building.jpg"  // Correct path to the image inside the public/assets folder
          alt="Our Building"
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-5xl mx-auto">
        <div className="bg-white p-6 rounded-xl shadow-md">
          <img
            src="/assets/levies.jpg"  // Correct path to the image inside the public/assets folder
            alt="Levies"
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          <img
            src="/assets/maintenance.jpg"  // Correct path to the image inside the public/assets folder
            alt="Maintenance"
            className="rounded-lg w-full mb-4"
          />
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          <img
            src="/assets/committee.jpg"  // Correct path to the image inside the public/assets folder
            alt="Committee"
            className="rounded-lg w-full mb-4"
          />
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          <img
            src="/assets/notices.jpg"  // Correct path to the image inside the public/assets folder
            alt="Notices"
            className="rounded-lg w-full mb-4"
          />
